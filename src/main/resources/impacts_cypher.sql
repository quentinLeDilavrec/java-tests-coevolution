...
FOREACH (l IN $rangesToType |
    ...
    ON CREATE SET cause.type = l.type, cause.isTest = l.isTest, cause.sig = l.sig, cause.path = l.astPath
    ON MATCH SET cause.isTest = l.isTest, cause.sig = l.sig, cause.path = l.astPath
...
FOREACH (l IN imp.causes |
    ...
    path:l.file, repo:l.repository, commitId:l.commitId})
    ON CREATE SET cause.type = l.type, cause.isTest = l.isTest, cause.sig = l.sig, cause.path = l.astPath
    ON MATCH SET cause.type = l.type, cause.isTest = l.isTest, cause.sig = l.sig, cause.path = l.astPath
